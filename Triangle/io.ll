...
target triple = "x86_64-pc-windows-msvc19.29.30156"
...
$"??_C@_03ONPDDLC@?5?$CFc?$AA@" = comdat any
...
@"??_C@_03ONPDDLC@?5?$CFc?$AA@" = linkonce_odr dso_local unnamed_addr constant [4 x i8] c" %c\00", comdat, align 1
...
define dso_local i32 @readInt() #0 {
  ...
  %2 = call i32 (ptr, ...) @scanf(ptr noundef @"??_C@_02DPKJAMEF@?$CFd?$AA@", ptr noundef %1)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8 @readChar() #0 {
  %1 = alloca i8, align 1
  %2 = call i32 (ptr, ...) @scanf(ptr noundef @"??_C@_03ONPDDLC@?5?$CFc?$AA@", ptr noundef %1)
  %3 = load i8, ptr %1, align 1
  ret i8 %3
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @printChar(i8 noundef %0) #0 {
  %2 = alloca i8, align 1
